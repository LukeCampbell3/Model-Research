...
```json
{
  ...
  "variant_metrics": {
    "baseline_output_head": {
      "loss": 0.45723155794742826,
      "accuracy": 0.06884832793354963,
      "readout_weight_norm_shared": 7.801002484746277,
      "readout_weight_norm_sparse": 76.5360528876384,
      "sparse_feature_utilization": 0.8922798124707707,
      "shared_feature_utilization": 0.15506214186219341,
      "logit_delta_from_sparse": 23.26655243895948,
      "correct_class_logit_delta": 0.12402330924745308,
      "incorrect_class_logit_delta": 2.3707534011142952,
      "final_state_feature_utilization": 0.8922798124707707
    }
  }
}
```