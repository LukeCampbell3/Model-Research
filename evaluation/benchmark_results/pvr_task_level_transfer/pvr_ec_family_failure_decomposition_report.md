...
```json
{
  ...
  "by_family": {
    "clrs_style": {
      ...
      "expert_contribution_pct": 0.8927741461439608,
      "calibration_proxy": 0.07047602660533542,
      "top_error_modes": [
    ...
    "dyck": {
      ...
      "owner_entropy": 0.0,
      "prototype_entropy": 0.0,
      "expert_contribution_pct": 0.8918826883748258,
      "calibration_proxy": 0.11153605039247201,
      "top_error_modes": [
        "low_sequence_accuracy",
        "decision_credit_or_aggregation"
      ]
    ...
    "listops": {
      ...
      "owner_entropy": 0.0,
      "prototype_entropy": 0.0,
      "expert_contribution_pct": 0.8960048874557448,
      "calibration_proxy": 0.04745422033743196,
      "top_error_modes": [
        "low_sequence_accuracy",
        "decision_credit_or_aggregation"
      ]
    ...
    "scan_style": {
      ...
      "owner_entropy": 0.0,
      "prototype_entropy": 0.0,
      "expert_contribution_pct": 0.890072898564443,
      "calibration_proxy": 0.10891413425239099,
      "top_error_modes": [
        "low_sequence_accuracy",
        "decision_credit_or_aggregation"
      ]
