# Pvr Ec Family Nlp Stage1 Summary
...
{
  "status": "PVR_EC_NLP_STAGE1_RESEARCH_ALLOWED_WITH_BLOCKERS",
  "total_time_s": 99.57537817955017,
  "device": "cuda",
  "tasks_evaluated": 8,
  "models_evaluated": [
    "pvr_full",
  ...
  "family_preservation_verdict": "PVR_EC_FAMILY_PRESERVATION_PASSED_WITH_BLOCKERS",
  "candidate_gate_verdict": "PVR_EC_FAMILY_PRESERVING_ROUTER_ACCEPTED",
  ...
  "expert_choice_evidence_summary": {
    "pvr_full": {
      "avg_challenger_win_rate": 0.34173583984375,
      "avg_agreement": 0.65826416015625
    },
    "pvr_full_fixed_owner_e0": {
      "avg_challenger_win_rate": 0.0048828125,
      "avg_agreement": 0.9951171875
    },
    "pvr_full_scale_4": {
      "avg_challenger_win_rate": 0.93304443359375,
      "avg_agreement": 0.06695556640625
    }
  },
  "canary_avg_owner_change_rate": 0.0003662109375
}
```