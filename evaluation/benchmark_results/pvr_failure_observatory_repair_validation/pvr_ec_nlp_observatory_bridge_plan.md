# PVR-EC NLP Observatory Bridge Plan
...
```json
{
  ...
  "stage_1_symbolic_to_text_tasks": [
    "copy",
    "reverse",
    "bracket",
    "algorithmic_text_adapter"
  ],
  "stage_2_small_nlp_tasks": [
    "tiny_lm_next_token",
    "synthetic_qa",
