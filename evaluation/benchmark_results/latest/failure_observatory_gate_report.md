...
```json
{
  ...
  "event_count": 194,
  "input_dirs": [
    "evaluation/benchmark_results/pvr_failure_observatory_smoke",
    ...
    "evaluation/benchmark_results/pvr_failure_observatory_repair_candidates",
    "evaluation/benchmark_results/pvr_failure_observatory_repair_validation"
  ],
  "loaded_report_names": [
    ...
    "pvr_ec_stability_repair_sweep_report.json",
  ...
  "trend": {
    ...
    "calibration_mean": 0.13220796198544646,
    "calibration_change": 0.0,
    "QPM_shape_pass_count": 166,
