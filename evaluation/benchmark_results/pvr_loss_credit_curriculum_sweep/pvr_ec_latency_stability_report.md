...
{
  "metadata": {
    "timestamp": "2026-06-07T02:35:06.336161",
    ...
    "root_cause_flags": {
      ...
      "run_loss_credit_repair_sweep": true,
      "run_curriculum_repair_sweep": true,
    ...
    "diagnostic_sweeps": {
      ...
      "loss_credit_variants": [
        "baseline_loss",
        "final_token_weight_2x",
        "final_token_weight_4x",
        "decision_token_weight_2x",
        "decision_token_weight_4x",
        "sequence_accuracy_proxy_weight",
        "family_balanced_loss",
        "listops_weight_2x",
        "scan_weight_2x",
        "dyck_weight_2x",
        "listops_scan_weight_2x"
      ],
      "curriculum_variants": [
        "baseline_curriculum",
        "easy_to_hard_length_curriculum",
        "easy_to_hard_depth_curriculum",
        "family_balanced_curriculum",
        "listops_scan_focused_curriculum"
      ]
    },
  ...
  "by_model": {
    "pvr_ec_ownership_top1_scale_schedule_1_to_8": {
      ...
      "latency_p50_ms": 611.7111146450043,
      "latency_p95_ms": 611.7111146450043,
  ...
  "rows": [
    {
      ...
      "latency_p50_ms": 731.5704822540283,
      "latency_p95_ms": 731.5704822540283,
      "latency_p99_ms": 731.5704822540283,
      "latency_max_ms": 731.5704822540283,
      "latency_std_ms": null,
      "latency_p95_p50_ratio": 1.0
    },
    {
      ...
      "batch_size": null,
      "sequence_length": null,
      "latency_p50_ms": 667.1698093414307,
      "latency_p95_ms": 667.1698093414307,
      "latency_p99_ms": 667.1698093414307,
      "latency_max_ms": 667.1698093414307,
      "latency_std_ms": null,
      "latency_p95_p50_ratio": 1.0
    },
    {
      ...
      "batch_size": null,
      "sequence_length": null,
      "latency_p50_ms": 700.6800174713135,
      "latency_p95_ms": 700.6800174713135,
      "latency_p99_ms": 700.6800174713135,
      "latency_max_ms": 700.6800174713135,
      "latency_std_ms": null,
      "latency_p95_p50_ratio": 1.0
    },
    {
      ...
      "batch_size": null,
      "sequence_length": null,
      "latency_p50_ms": 712.6028537750244,
      "latency_p95_ms": 712.6028537750244,
      "latency_p99_ms": 712.6028537750244,
      "latency_max_ms": 712.6028537750244,
      "latency_std_ms": null,
      "latency_p95_p50_ratio": 1.0
    },
    {
      ...
      "batch_size": null,
      "sequence_length": null,
      "latency_p50_ms": 645.7934379577637,
      "latency_p95_ms": 645.7934379577637,
      "latency_p99_ms": 645.7934379577637,
      "latency_max_ms": 645.7934379577637,
      "latency_std_ms": null,
      "latency_p95_p50_ratio": 1.0
    },
    {
      ...
      "batch_size": null,
      "sequence_length": null,
      "latency_p50_ms": 327.63099670410156,
      "latency_p95_ms": 327.63099670410156,
      "latency_p99_ms": 327.63099670410156,
      "latency_max_ms": 327.63099670410156,
      "latency_std_ms": null,
      "latency_p95_p50_ratio": 1.0
    },
    {
      ...
      "batch_size": null,
      "sequence_length": null,
      "latency_p50_ms": 632.6134204864502,
      "latency_p95_ms": 632.6134204864502,
      "latency_p99_ms": 632.6134204864502,
      "latency_max_ms": 632.6134204864502,
      "latency_std_ms": null,
      "latency_p95_p50_ratio": 1.0
    },
    {
      ...
      "batch_size": null,
      "sequence_length": null,
      "latency_p50_ms": 475.6278991699219,
      "latency_p95_ms": 475.6278991699219,
      "latency_p99_ms": 475.6278991699219,
      "latency_max_ms": 475.6278991699219,
      "latency_std_ms": null,
      "latency_p95_p50_ratio": 1.0
    }
  ]
