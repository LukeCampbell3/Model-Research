...
**Mode:** benchmark-lite | **Scale:** tiny | **Steps:** 10  
**Families:** dyck  
**Samples:** 112 | **Time:** 77.7s

## Reason
Only 1/4 families succeeded: ['dyck'] dense (0.0000) >= all MoE variants — MoE overhead not justified
...
|-------|--------|---------|--------|----------|---------|-----------|
| fixed_moe | 260,932 | 0.0000 | 0.0000 | 4.578 | 0.0000 | 1.0 |
| pvr_ec | 136,194 | 0.0000 | 0.0000 | 4.608 | 0.0000 | 1.0 |
