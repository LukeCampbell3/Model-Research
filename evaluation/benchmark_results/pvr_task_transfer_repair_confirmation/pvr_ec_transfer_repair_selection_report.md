...
```json
{
  ...
  "repair_scores": {
    "no_architecture_scale_control": {
      "benchmark_loss_improvement": -0.012504214537329972,
      "sequence_accuracy_improvement": -0.01660334619009652,
      "token_to_sequence_transfer_gain": -1.471803879766914,
      "calibration_regression": 0.0,
      "latency_regression": 0.0,
      "implementation_complexity_penalty": 0.0,
      "score": -1.5009114404943404
    },
  ...
  "selected_repair": "readout_repair_diagnostic_only",
  "selected_model": "pvr_ec_ownership_top1_best_transfer_repair",
  "tie_breakers": [
