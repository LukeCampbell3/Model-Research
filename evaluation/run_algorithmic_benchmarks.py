...
def main():
    ...
    parser.add_argument("--mode", choices=["smoke", "benchmark-lite", "benchmark-full", "inference-only", "pvr-overfit-sanity", "pvr-nlp-stage1"], default="smoke")
    ...
    parser.add_argument("--run-pvr-family-preservation-smoke", action="store_true")
    parser.add_argument("--run-pvr-family-preservation-analysis", action="store_true")
    parser.add_argument("--run-pvr-boundary-noisy-region-analysis", action="store_true")
    parser.add_argument("--run-pvr-family-oracle-gap-analysis", action="store_true")
    parser.add_argument("--summarize-pvr-family-preservation", action="store_true")
    parser.add_argument("--mode-pvr-nlp-stage1", action="store_true")
    parser.add_argument("--run-nlp-stage1-dataset-report", action="store_true")
    parser.add_argument("--run-nlp-stage1-model-comparison", action="store_true")
    parser.add_argument("--run-nlp-stage1-length-generalization", action="store_true")
    parser.add_argument("--summarize-pvr-nlp-stage1-failure-observatory", action="store_true")
    parser.add_argument("--summarize-pvr-family-nlp-stage1-gate", action="store_true")
    parser.add_argument("--run-pvr-family-preservation-shadow", action="store_true")
    parser.add_argument("--run-pvr-expert-choice-teacher-evidence", action="store_true")
    parser.add_argument("--run-pvr-family-map-candidate-refresh", action="store_true")
    parser.add_argument("--run-pvr-family-preserving-candidate-canary", action="store_true")
    parser.add_argument("--summarize-pvr-family-oracle-gap-repair", action="store_true")
    parser.add_argument("--summarize-pvr-family-preserving-routing-gate", action="store_true")
    parser.add_argument("--enable-family-preservation-observatory", action="store_true")
