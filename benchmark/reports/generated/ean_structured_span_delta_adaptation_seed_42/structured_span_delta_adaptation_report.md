...
```json
{
  ...
  "comparison": {
    ...
    "repaired_lm_loss": 3.217206156253815,
    "repaired_mean_eval_loss": 3.54313440322876,
  ...
  "created_at": "2026-06-17T03:22:31.090802+00:00",
  ...
  "row": {
    ...
    "checkpoint_manifest": "benchmark/reports/generated/ean_structured_span_delta_adaptation_seed_42/pvr_ec_o_embeddings_attention_norms_init_v1_structured_delta_adaptation_seed_42/checkpoint_manifest.json",
    "checkpoint_path": "checkpoints/ean_structured_span_delta_adaptation_seed_42/pvr_ec_o_embeddings_attention_norms_init_v1_structured_delta_adaptation_seed_42/checkpoint.pt",
    "effective_batch_tokens": 256,
    "error": null,
    "eval_curve": "benchmark/reports/generated/ean_structured_span_delta_adaptation_seed_42/pvr_ec_o_embeddings_attention_norms_init_v1_structured_delta_adaptation_seed_42/eval_curve.json",
    "eval_window_count": 10,
    "final_loss": 4.7065300941467285,
    "gpu_hours": 0.03956648601426019,
    "hardware_manifest": "benchmark/reports/generated/ean_structured_span_delta_adaptation_seed_42/pvr_ec_o_embeddings_attention_norms_init_v1_structured_delta_adaptation_seed_42/hardware_manifest.json",
    "model_variant": "pvr_ec_o_embeddings_attention_norms_init_v1_structured_delta_adaptation_seed_42",
    "optimizer_steps": 1000,
    "routing_curve": "benchmark/reports/generated/ean_structured_span_delta_adaptation_seed_42/pvr_ec_o_embeddings_attention_norms_init_v1_structured_delta_adaptation_seed_42/routing_curve.json",
    "routing_window_count": 10,
    "status": "GENUINE_REDUCED_TRAINING_COMPLETE",
    "throughput_log": "benchmark/reports/generated/ean_structured_span_delta_adaptation_seed_42/pvr_ec_o_embeddings_attention_norms_init_v1_structured_delta_adaptation_seed_42/throughput_log.json",
    "tokens_seen": 256000,
    "training_curve": "benchmark/reports/generated/ean_structured_span_delta_adaptation_seed_42/pvr_ec_o_embeddings_attention_norms_init_v1_structured_delta_adaptation_seed_42/training_curve.json",
    "training_tokens_seen": 256000,
    "vram_peak": 1935715840
  },
  "schema_version": "1.0",
  "scorecard": {
    ...
    "config": {
      ...
      "num_layers": 24,
      "optimizer": "adamw",
      "output_path": "benchmark/reports/generated/ean_structured_span_delta_adaptation_seed_42/pvr_ec_o_embeddings_attention_norms_init_v1_structured_delta_adaptation_seed_42",
      "precision": "bf16",
    ...
    "created_at": "2026-06-17T03:22:14.768893+00:00",
    "environment": {
      "cwd": "/workspace",
      "machine": "x86_64",
    ...
    "scorecard": {
      ...
      "checkpoint": "checkpoints/ean_structured_span_delta_adaptation_seed_42/pvr_ec_o_embeddings_attention_norms_init_v1_structured_delta_adaptation_seed_42/checkpoint.pt",
      "code_eval_token_count": 12800,
      "code_token_loss": 4.971884207129478,
      "contamination_scan": "CONTAMINATION_STATUS_UNKNOWN",
      "context_length": 4096,
      "copy_span_loss": null,
      "eval_latency_ms_per_token": 0.7455816771835089,
      ...
      "json_token_loss": 4.971884207129478,
      ...
      "math_lvl_5": null,
      "math_token_loss": 4.971884207129478,
      "mmlu_pro": null,
  ...
  "structured_windows": {
    "windows": {
      "3600": {
        ...
        "repaired_ean": {
          "delta_vs_baseline": -5.243807792663574,
          "loss": 3.621628761291504
        }
      },
      "4000": {
        "dense_300m": {
        ...
        "repaired_ean": {
          "delta_vs_baseline": -8.099663257598877,
          "loss": 2.9680399894714355
        }
      }
    }
  }
