# Self-Instilled Trunk Curriculum vs EAN Replay Audit

Status: `PVR_SELF_INSTILLED_TRUNK_CURRICULUM_NOT_RUN_MISSING_ARTIFACTS`

| candidate | config | checkpoint | status |
|---|---|---|---|
| pvr_random_full_scratch | False | False | NOT_RUN_MISSING_ARTIFACT |
| pvr_self_instilled_trunk_curriculum | False | False | NOT_RUN_MISSING_ARTIFACT |
| pvr_ean | True | True | ARTIFACT_READY |
| pvr_ean_retention_gated_delta_replay_v1 | True | True | ARTIFACT_READY |
| dense_300m | True | True | ARTIFACT_READY |
| switch_300m | True | True | ARTIFACT_READY |
...
```json
{
  ...
  "created_at": "2026-06-18T18:52:45.373623+00:00",
  "decision_rule": "This audit can only support teacher independence if a real self-instilled curriculum artifact exists and can be compared against EAN replay, dense, and Switch references. Missing self-instilled artifacts keep teacher independence blocked.",
  "experiment": "PVR_SELF_INSTILLED_TRUNK_CURRICULUM_VS_EAN_REPLAY",
  ...
  "rows": [
    ...
    },
    {
      ...
      "config_exists": false,
      "config_path": null,
      "key": "pvr_self_instilled_trunk_curriculum",
      "status": "NOT_RUN_MISSING_ARTIFACT"
    },
    {
    ...
    },
    {
      ...
      "key": "pvr_ean_retention_gated_delta_replay_v1",
      "model_family": "pvr_ec_o",
  ...
  "supported_conditions": {
    "dense_reference_checkpoint_present": true,
    "ean_replay_checkpoint_present": true,
    "self_instilled_checkpoint_present": false,
    "self_instilled_config_present": false,
    "switch_reference_checkpoint_present": true
  }
}
```
