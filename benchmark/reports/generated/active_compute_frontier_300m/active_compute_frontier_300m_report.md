# Active Compute Frontier 300M

Status: `PVR_ACTIVE_COMPUTE_PARETO_ADVANTAGE_SUPPORTED`

| model | broad LM | active params/token | active FLOPs/token | tokens/sec | VRAM peak | quality/param | quality/FLOP | Top1 clean |
|---|---:|---:|---:|---:|---:|---:|---:|---|
| dense_300m | 2.776603478938341 | 300000000 | 1800000000 | 10881.876622690079 | 1053412864 | 1.2005075116479587e-09 | 2.000845852746598e-10 | None |
| switch_top1_300m | 2.781601406633854 | 105000000 | 630000000 | 1709.0843074806269 | 1100439040 | 3.4238584655213888e-09 | 5.706430775868981e-10 | None |
| generic_top2_300m | 2.779079955071211 | 150000000 | 900000000 | 1612.8913045989152 | 1100439040 | 2.398875445991204e-09 | 3.998125743318674e-10 | None |
| pvr_baseline_300m | 2.824210923165083 | 105000000 | 630000000 | 2106.8618706365955 | 1199062528 | 3.372201929286579e-09 | 5.620336548810965e-10 | True |
| pvr_ean_300m | 2.595274433493614 | 105000000 | 630000000 | 2317.2446125457013 | 1199062528 | 3.669673388254783e-09 | 6.116122313757972e-10 | True |
| pvr_ean_retention_gated_delta_replay_v1_300m | 2.571919046342373 | 105000000 | 630000000 | 2341.02759854127 | 1199062528 | 3.7029973930764686e-09 | 6.171662321794114e-10 | True |

```json
{
  "benchmark_evidence_caveat": "Local reduced-file active-compute audit; official benchmark adapters remain separate.",
  "broad_windows": 64,
  ...
  "configs": {
    ...
    "pvr_ean_retention_gated_delta_replay_v1_300m": "benchmark/reports/generated/ean_structured_delta_replay_retention_gated_seed_42/pvr_ec_o_ean_retention_gated_delta_replay_v1_300m_config.json",
    "switch_top1_300m": "benchmark/reports/generated/training_300m_real_4k/vanilla_switch_top1_reference_300m/run_config.yaml"
  },
  "created_at": "2026-06-17T20:57:49.981497+00:00",
  "decision_rule": "Support requires the candidate to be Pareto-efficient on broad LM loss versus active params/FLOPs, beat dense/Switch/Top2 broad LM loss, and preserve clean strict Top1 invariants.",
  "device": "cuda",
  "experiment": "PVR_ACTIVE_COMPUTE_FRONTIER_300M",
  "git_commit": "d18165e32bec94cea3ca836937c81f6a0f3dc5f7",
  "rankings": {
    "loss_ascending": [
      {
        "broad_lm_loss": 2.571919046342373,
        "model": "pvr_ean_retention_gated_delta_replay_v1_300m"
      },
      {
      ...
      },
      {
        ...
        "model": "generic_top2_300m"
      },
      {
        "broad_lm_loss": 2.781601406633854,
        "model": "switch_top1_300m"
      },
      {
        "broad_lm_loss": 2.824210923165083,
        "model": "pvr_baseline_300m"
      }
    ],
    ...
    "tokens_per_second_descending": [
      {
        "model": "dense_300m",
        "tokens_per_second": 10881.876622690079
      },
      {
        "model": "pvr_ean_retention_gated_delta_replay_v1_300m",
        "tokens_per_second": 2341.02759854127
      },
      {
        "model": "pvr_ean_300m",
        "tokens_per_second": 2317.2446125457013
      },
      {
        "model": "pvr_baseline_300m",
        "tokens_per_second": 2106.8618706365955
      },
      {
        "model": "switch_top1_300m",
        "tokens_per_second": 1709.0843074806269
      },
      {
        "model": "generic_top2_300m",
        "tokens_per_second": 1612.8913045989152
      }
    ]
  },
  "rows": {
    "dense_300m": {
      ...
      "elapsed_seconds": 1.7408761978149414,
      ...
      "quality_per_active_flop": 2.000845852746598e-10,
      "quality_per_active_param": 1.2005075116479587e-09,
      "quality_per_ms": 3.9191323879097277,
      "routing_snapshots": [],
      "slice_summary": {
        "broad_lm": {
    ...
    "generic_top2_300m": {
      ...
      "elapsed_seconds": 11.74536681175232,
      ...
      "quality_per_active_flop": 3.998125743318674e-10,
      "quality_per_active_param": 2.398875445991204e-09,
      "quality_per_ms": 0.5803688021482587,
      "routing_snapshots": [],
      "slice_summary": {
        "broad_lm": {
    ...
    "pvr_baseline_300m": {
      ...
      "elapsed_seconds": 8.99157190322876,
      ...
      "quality_per_active_flop": 5.620336548810965e-10,
      "quality_per_active_param": 3.372201929286579e-09,
      "quality_per_ms": 0.7460001848146112,
      "routing_snapshots": [
        {
    ...
    "pvr_ean_300m": {
      ...
      "elapsed_seconds": 8.17522668838501,
      ...
      "quality_per_active_flop": 6.116122313757972e-10,
      "quality_per_active_param": 3.669673388254783e-09,
      "quality_per_ms": 0.8928707433172511,
      "routing_snapshots": [
        {
          "challenger_disagreement_rate": null,
    ...
    "pvr_ean_retention_gated_delta_replay_v1_300m": {
      ...
      "elapsed_seconds": 8.092172861099243,
      ...
      "quality_per_active_flop": 6.171662321794114e-10,
      "quality_per_active_param": 3.7029973930764686e-09,
      "quality_per_ms": 0.9102260049244308,
      "routing_snapshots": [
        {
          "challenger_disagreement_rate": null,
    ...
    "switch_top1_300m": {
      ...
      "elapsed_seconds": 11.084298133850098,
      ...
      "quality_per_active_flop": 5.706430775868981e-10,
      "quality_per_active_param": 3.4238584655213888e-09,
      "quality_per_ms": 0.6144245913180171,
      "routing_snapshots": [],
      "slice_summary": {
        "broad_lm": {
