...
Caveat: `PVR_EAN_RETENTION_GATED_DELTA_REPLAY_REDUCED_AUDIT_SUPPORTED`

At 300M, EAN initialization plus retention-gated structured expert-delta replay preserves or improves EAN broad/prose behavior, improves code/JSON structured slices, improves unseen structured spans, survives two replay-sampling seeds, and preserves strict Top1 invariants under the reduced repeat/promotion audit.

## Seed Summary

| seed | broad delta | code delta | json delta | unseen structured delta | Top1 clean |
|---:|---:|---:|---:|---:|---|
| 42 | -0.023355387151241302 | -1.3145437240600586 | -2.163301706314087 | -1.7389227151870728 | True |
| 123 | -0.047335829585790634 | -1.7631248235702515 | -2.1051650047302246 | -1.934144914150238 | True |

```json
{
  "all_top1_invariants_clean": true,
  "benchmark_evidence_caveat": "This is reduced repeat/promotion audit support. Official broad NLP/code benchmark support remains blocked until full adapters and full benchmark promotion audit run.",
  "candidate": "pvr_ec_o_ean_retention_gated_delta_replay_v1",
  "candidate_config": "benchmark/configs/generated/pvr_ec_o_ean_retention_gated_delta_replay_v1_300m.yaml",
  "canonical_checkpoint_path": "checkpoints/ean_structured_delta_replay_retention_gated_seed_42/pvr_ec_o_ean_retention_gated_delta_replay_v1_seed_42/checkpoint.pt",
  "caveated_status": "PVR_EAN_RETENTION_GATED_DELTA_REPLAY_REDUCED_AUDIT_SUPPORTED",
  "created_at": "2026-06-17T19:27:40.398704+00:00",
  "do_not_promote": [
  ...
  "repeat_report": "benchmark/reports/generated/ean_retention_gated_delta_replay_repeat_decision/retention_gated_delta_replay_repeat_report.json",
  "repeat_seed_count": 2,
  "schema_version": "1.0",
  "seed_summaries": [
    {
  ...
  "status": "PVR_EAN_RETENTION_GATED_DELTA_REPLAY_PROMOTION_REPEAT_SUPPORTED",
  "supported_claim": "At 300M, EAN initialization plus retention-gated structured expert-delta replay preserves or improves EAN broad/prose behavior, improves code/JSON structured slices, improves unseen structured spans, survives two replay-sampling seeds, and preserves strict Top1 invariants under the reduced repeat/promotion audit.",
