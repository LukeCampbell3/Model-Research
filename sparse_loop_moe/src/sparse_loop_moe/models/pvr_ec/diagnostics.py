...
PVR_EC_STATUSES = (
    ...
    "PVR_EC_SEED_FAMILY_COLLAPSE_REPAIRED",
    "PVR_EC_SEED_FAMILY_COLLAPSE_REMAINS",
    "PVR_EC_MINIMAX_SELECTION_HELPFUL",
    "PVR_EC_FAMILY_BALANCED_TRAINING_HELPFUL",
    "PVR_EC_GRADIENT_CLIP_STABILITY_HELPFUL",
    "PVR_EC_LOGIT_NORM_CAP_STABILITY_HELPFUL",
    "PVR_EC_WRONG_SUPPRESS_STABILITY_HELPFUL",
    "PVR_EC_TEMPERATURE_CALIBRATION_HELPFUL",
    ...
    "PVR_EC_NLP_BRIDGE_STAGE_BLOCKED",
    "PVR_EC_FAILURE_OBSERVATORY_READY",
    "PVR_EC_FAILURE_OBSERVATORY_INCOMPLETE",
    "PVR_EC_FAILURE_CASES_REPLAYED",
    "PARTIAL_PVR_EC_FAILURE_OBSERVATORY",
    "PVR_EC_RESEARCH_EXPANSION_ALLOWED",
    "PVR_EC_RESEARCH_EXPANSION_BLOCKED",
    "PVR_EC_DEPLOYMENT_STILL_BLOCKED",
    "PVR_EC_INCORRECT_OVERAMP_COLLAPSE",
    "PVR_EC_CALIBRATION_COLLAPSE",
    "PVR_EC_SPARSE_RESIDUAL_UNHELPFUL_COLLAPSE",
    "PVR_EC_LOCAL_TO_GLOBAL_COLLAPSE",
    "PVR_EC_OWNER_PROTOTYPE_COLLAPSE",
    "DATA_SPLIT_DIFFICULTY_CASE",
    "PARTIAL_PVR_EC_MINIMAX_STABILITY_AND_RESEARCH_READINESS",
    "PVR_EC_MATCHED_WALL_CLOCK_BLOCKED",
